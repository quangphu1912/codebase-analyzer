...
Verify installation by checking that the plugin was cached:

```
ls ~/.cache/opencode/node_modules/codebase-analyzer/
```

Or ask OpenCode: "Analyze this codebase" or "What analysis skills do you have?"
